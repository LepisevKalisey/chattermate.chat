...
class Settings(BaseSettings):
    ...
    EMBEDDING_PROVIDER: str = os.getenv("EMBEDDING_PROVIDER", "fastembed")  # "fastembed", "openai", or "google"
    EMBEDDING_MODEL: str = os.getenv("EMBEDDING_MODEL", "text-embedding-3-small")  # e.g., "text-embedding-3-small" or "models/text-embedding-004"
